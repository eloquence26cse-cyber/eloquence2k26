...
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SECRET_KEY || process.env.service_role || process.env.SUPABASE_ANON_KEY || process.env['SUPABASE_anon-key'];
